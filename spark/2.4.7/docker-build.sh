...
# extract
tar -xf $WORK_DIR/spark-2.4.7-bin-without-hadoop.tgz -C $WORK_DIR
...
function build_and_push_spark() {
    ...
    docker push $DOCKER_REGISTRY/spark-2.4.7-without-hadoop:alpha 
}
...
function build_and_push_spark_r() {
    ...
    # already logged in Makefile
    docker push $DOCKER_REGISTRY/spark-2.4.7-without-hadoop-with-r:alpha 
}
